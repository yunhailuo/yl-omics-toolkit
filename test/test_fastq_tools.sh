...
python $DIR/../yl_fastq_tools.py -f input.fastq -s 18: -r 1:5,12:17 -i 6:11 -b CGTGAT,ACATCG,CACTGT:Sample1_processed.fastq\;CTGATC:Sample2_processed.fastq\;AAGCTA,GCGGAC:Sample3_processed.fastq
